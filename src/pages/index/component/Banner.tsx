      ...
      <div className="flex justify-between items-center bg-amber-300/20 xl:max-w-[78rem] xl:mx-auto">
        ...
        <div>
          ...
          <div className="text-center py-2">
            ...
            <p className="text-xs md:font-semibold text-amber-950">
              Subscribe to our Channel and get 15% off discount code
            </p>
            <form className="mt-5 flex justify-between gap-x-3">
              <input
                className="px-2 py-1 w-32 md:w-full rounded-full placeholder:text-xs hover:shadow-[0_0_5px_2px_#451a03] transition-all duration-300"
                type="email"
