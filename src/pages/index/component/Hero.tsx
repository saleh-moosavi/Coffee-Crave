  ...
  return (
    <div className="h-screen w-screen relative z-10">
      ...
      <ul className="flex w-full h-[10%] justify-center items-center gap-x-10 md:gap-x-32 lg:gap-x-52 bg-amber-950/10 text-amber-950 fill-amber-950">
        <li className="flex flex-col gap-y-1 items-center text-sm font-semibold cursor-pointer">
          <TbCoffee className="w-8 h-8 hover:scale-105 transition-all duration-300" />
          Hot Coffee
          <br />
        </li>
        <li className="flex flex-col gap-y-1 items-center text-sm font-semibold cursor-pointer">
          <SiBuymeacoffee className="w-8 h-8 hover:scale-105 transition-all duration-300" />
          Cup Coffee
        </li>
        <li className="flex flex-col gap-y-1 items-center text-sm font-semibold cursor-pointer">
          <GiChocolateBar className="w-8 h-8 hover:scale-105 transition-all duration-300" />
          Chocolate
        </li>
        <li className="flex flex-col gap-y-1 items-center text-sm font-semibold cursor-pointer">
          <GiCakeSlice className="w-8 h-8 hover:scale-105 transition-all duration-300" />
          Dessert
        </li>
      </ul>
    </div>
